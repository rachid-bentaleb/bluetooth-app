...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        discoverable_btn = findViewById(R.id.discoverable)
        paired_btn = findViewById(R.id.paired)
        bluetooth_img = findViewById(R.id.image_bluetooth)
        statusBluetooth = findViewById(R.id.status_bluetooth)
        paired = findViewById(R.id.result)
